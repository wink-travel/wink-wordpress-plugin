function initIkoLookup() {
    ...
    ikoRegisterBlockType( 'ikotravel-blocks/'+blockName, {
        title: iko__( 'iko.travel Lookup' ), // Block title.
            ...
            if (ikoTravelData.mode == 'staging' || ikoTravelData.mode == 'development') {
                ...
                var preview = ikoCreateElement(
                    ...
                    ikoCreateElement(
                        ...
                        iko__('Where are you headed?')
                    ),
                    ikoCreateElement(
                        'img',
                        {
                            src: ikoTravelData.imgURL+'arrow-down.svg'
                        }
                    ),
                );
            }
